...
public class Warmup_1 {
	...
	// char added at the front and back,
	...
	// chars added at both the front and back,
	...
	public int close10(int a, int b) {
		int amin = Math.abs(a - 10);
		int bmin = Math.abs(b - 10);
	...
	// upper case.
	// If the string has less than 3 chars, uppercase whatever is there. Note
	// that str.toUpperCase()
